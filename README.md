...
<p align="center">
  <strong>影视搜索、榜单探索、订阅、115 转存、自动归档、STRM 生成、Emby 联动的一体化媒体同步工具</strong>
</p>
...
当前提供 `latest` 和明确版本号 tag，例如 `1.1.2`；多架构镜像会由 Docker 客户端按宿主机平台自动选择对应版本。
...
- 使用固定版本 tag，例如 `1.1.2`：适合想锁版本的用户，但通常不会收到“新版本可更新”提示
