...
```text
https://hub.docker.com/r/wabisabi926/mediasync115
```
...
```bash
docker pull wabisabi926/mediasync115:latest
...
docker run -d \
  ...
  wabisabi926/mediasync115:latest
```
...
services:
  app:
    image: wabisabi926/mediasync115:latest
